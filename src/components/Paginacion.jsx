  ...
  return (
    <>
      <div className="flex justify-around py-6 items-center md:justify-center md:gap-8 ">
        ...
        <button className='flex md:hidden py-2 px-4 bg-cardDark text-darkText font-semibold rounded-md text-lg shadow-md shadow-slate-800' onClick={() => cambiarPagina(paginaActual - 1)}> Previous </button>
        <button className='flex md:hidden py-2 px-4 bg-cardDark text-darkText font-semibold rounded-md text-lg shadow-md shadow-slate-800' onClick={() => cambiarPagina(paginaActual + 1)}> Next </button>
