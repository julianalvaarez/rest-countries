    ...
    <header>
      <nav className='dark:bg-cardDark shadow-md shadow-slate-300 dark:shadow-slate-800 bg-white'>
        <ul className='flex justify-between mx-3 p-2 text-lightText items-center py-6 dark:text-white'>
            ...
            <li onClick={handleChangeTheme} className='hidden dark:flex items-center gap-2 cursor-pointer'><BsMoonFill/> Dark Mode</li>
            <li onClick={handleChangeTheme} className='flex dark:hidden items-center gap-2 cursor-pointer'><BsFillSunFill/> Light Mode</li>
        </ul>
      </nav>
    </header>
  )
